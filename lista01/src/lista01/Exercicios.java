...
public class Exercicios {
	 ...
	 */
	public static double calcularMediaPonderada(double dnota1, double peso1, double dnota2, double peso2, double dnota3,
			double peso3) {
	 ...
	 * @param velocidadeMedia - Velocidade média durante a viagem em quilômetros por
	 *                        hora.
	...
	/**
	 * Ex07 . Método para calcular o valor final a ser pago por um compra com
	 * acréscimo.
	 * 
